...
Find each game in its respective subfolder and see the README.md for that game. If there are associated modding tools for a game, they will have corresponding subfolders below the game. I will note in the game's README.md when and what hardware/os/version of the game was tested.
