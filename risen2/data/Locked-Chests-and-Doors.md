...
This section is for being able to reference the maximum lock level you can successfully unlock with various combinations of Cunning ranks, skills, items, and potions. Since the permanent potion is rare and doesn't increase Thievery by 5 or more in one go, I am omitting that from the charts because it is a pain to manage all the extra permutations that adds in.
